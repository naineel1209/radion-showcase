...
const Header = () => {
  return (
    <div className='sticky md:top-[1.5rem] top-0 z-50 bg-primary-light dark:bg-primary-dark backdrop-blur-md'>
      <div className='md:w-[60%] w-[100%] mx-auto border-2 rounded-lg flex items-center justify-between md:gap-[5rem] bg-primary-dark/10 dark:bg-primary-light/10 backdrop-blur-md p-2'>
